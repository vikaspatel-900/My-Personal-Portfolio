            ...
            <div className="timeline">
                ...
                <div className="container right-container">
                    ...
                    <div className="text-box">
                        ...
                        <small>Rajiv Gandhi Proudyogiki Vishwavidyalaya,  <p>CGPA - 7.46</p></small>
                ...
                <div className="container left-container">
                    ...
                    <div className="text-box">
                        ...
                        <small>Model Higher Secondary School,  <p>Percentage - 65 %</p></small>
                ...
                <div className="container right-container">
                    ...
                    <div className="text-box">
                        <h2>High School</h2>
                        <small>Model Higher Secondary School, , <p>Percentage - 81 %</p></small>
